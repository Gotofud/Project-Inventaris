    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form Input Group -->
                <form action="{{ route('loan.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Borrower's name" aria-label="brws_name"
                            aria-describedby="basic-addon1" name="brws_name" value="{{ $data->brws_name }}">
                    </div>
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <ul class="dropdown-menu w-100" aria-labelledby="itemsDropdown" style="max-height: 250px; overflow-y: auto;">
                                @foreach ($l_Maindata as $mainItem)
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" placeholder="Entry Date" aria-label="Password"
                                aria-describedby="basic-addon1" name="loan_date" value="{{ $data->loan_date }}">
                        </div>
                        <div class="input-group mb-3">
