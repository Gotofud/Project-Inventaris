    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel"><i class="ti ti-room"></i> Edit Room</h1>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('room.update', $data->id) }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Room Name" name="room_name" value="{{ $data->room_name }}">
                    </div>
            </div>
